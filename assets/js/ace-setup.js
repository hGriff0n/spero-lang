...
include("https://cdn.jsdelivr.net/ace/1.1.3/noconflict/ace.js", function () {
    include("{{ site.baseurl }}assets/js/mode-spero.js", function () {
    // include("{{site.baseurl}}assets/ace-builds/src-noconflict/mode-lua.js", function() {
        (function () {
            "use strict";
            ...
            editor.getSession().setMode("ace/mode/spero");
